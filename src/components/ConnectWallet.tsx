...
export default function ConnectWallet() {
    ...
    const sendTransactionFunction = async () => {
        ...
        const response = await fetch("https://7866-129-126-214-63.ngrok-free.app/api/contracts/txn-data", requestOptions)
    ...
    const sendMessageToExtension = () => {
        ...
        // @ts-ignore
        chrome.runtime.sendMessage(editorExtensionId, signer,
        ...
        >
            <div>
                ...
                <h1 style={{
                    ...
                    {isConnected ? `Welcome, You are Signed In` : "Let's create your wallet"}
                </h1>
                <span
                    style={{
                        display: 'block',
                ...
                >
                    {isConnected ? `Connect your first contract with to create the agentx automation` : <span>
                        You can create a <span style={{
                            fontWeight: 'bold'
                        }}>
                            Reown Smart Wallet </span>
                        to start using the platform. we recommend use email signin to secure your wallet.</span>}
                </span>
                <div style={{
                    display: 'flex',
                    justifyContent: 'center',
