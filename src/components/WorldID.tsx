...
export default function WorldID({ setStage, isWorldIDVerified, setIsWorldIDVerified }: WorldIDProps) {
    ...
    return (
        ...
        >
            ...
            >
                We want you to verify your identity with World ID to access the platform.
                this will help us keeping bots and scammers away.
            </span>
            <div>
                <img src={worldid} alt="World ID" style={{
                    width: '100%',
                    maxWidth: '150px',
                    display: 'block',
                    margin: 'auto',
